		...
		<table width="600" align="center" style="background-color: #fff;">
			...
			<tr>
				<td style="padding:0px 10px;">
					...
					<p><h4><strong>Confirmation No: </strong><small>{{ $registration->confirmation_no }}</small></h4></p>
					<p>
    				...
    				<p>Please e-mail a scanned copy of your deposit slip as proof of payment to conference@amic.asia.</p>
