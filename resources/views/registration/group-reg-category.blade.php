			...
			<div class="col-md-12">
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							<td style="width: 25%;">
								<input type="radio" name="payment_opt" id="bank" value="bank" {{ (session('group_reg.payment_opt') == 'bank') ? 'checked' : ''  }} />
								Bank Deposit
							</td>
							<td>
						...
						<tr>
							<td>
								<input type="radio" name="payment_opt" id="creditcard" value="creditcard" {{ (session('group_reg.payment_opt') == 'creditcard') ? 'checked' : ''  }} />
