...
@section('content')
	<div class="bg-white padding page-content">
		<h4 class="text-center">ASIAN MEDIA INFORMATION AND COMMUNICATION CENTRE (AMIC)<br />
		25th INTERNATIONAL CONFERENCE</h4>

		<h5 class="text-center"><strong><i>Rethinking Communication in a Resurgent Asia</i></strong></h5>

		<p class="text-center"><strong>27-29 September 2017, Manila Philippines</strong></p>
		...
		<ul>
			...
			<li>Media History and Asian Perspectives: Remembering the Past for the Future</li>
			<li>Cultural Traditions and Communication Theory</li>
			<li>Asian Research Framework and Methodologies</li>
		</ul>	
		

		<p><i>Cluster on Communication and Culture</i></p>
		<ul>
			<li>Protecting and Preserving Our Cultural Heritage (Amidst Natural and Man-made Disasters)</li>
			<li>Intercultural Dialogue for Tolerance, Harmony, and Peace</li>
			<li>Addressing Hate Speech, Radicalism, and Extremism in Asian Media</li>
		</ul>
		<p><i>Cluster on Communication Education</i></p>
		<ul>
			<li>Asian Higher Education Integration</li>
			<li>Accreditation Standards for Asia-Pacific Communication Schools</li>
		</ul>
		<p><i>Cluster on Communication Media</i></p>
		<ul>
		...
		<ul>
			...
			<li>Risk, Disaster, and Humanitarian Communication</li>
			<li>Health Communication (including Behavior and Social Change)</li>
		</ul>
		<p><i>Cluster on Inclusive Knowledge Societies</i></p>
		<ul>
			<li>Access to Knowledge and Information by Persons with Disabilities</li>
			<li>Access to Knowledge and Information by Indigenous People</li>
			<li>Right to Information of Internally Displaced Persons</li>
			<li>Access Beyond Genders (and Gender Preference)</li>
		</ul>
		<p><i>Cluster on Global Communication</i></p>
		<ul>
			<li>Communication and the Asian Diaspora (Migration)</li>
		...
		<ul>	
			...
			<li>Trade and Investment Communication</li>
			<li>Cross-cultural Business Communication in an Asian Setting</li>
		</ul>
		<a id="abstract"></a>
		<h4>SCHEDULE OF SUBMISSIONS</h4>
		<p>Papers will be selected on a competitive basis and all submissions will be screened by an expert panel.</p>
		
		<!--p><strong>Abstracts due:</strong> 31 March 2017<br />
		<strong>Notification of acceptance:</strong> May 2017<br />
		<strong>Full papers due:</strong> July 2017</p-->

		<ul>
			<li><strong>Abstracts due:</strong> 31 March 2017 (for resubmissions)</br> &#160;&#160;&#160;&#160;&#160;&#160;&#160;
			&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; 31 May 2017 (for new abstracts)
</li>
		...
		<p>Indicate your proposed Conference Cluster (and specific stream) in the subject line of your e-mail.</p>

		<p>E-mail should include the following:</p>
		<ul>
			<li>paper title</li>
			<li>author name, position, institution</li>
			<li>short biography of author (100 words)</li>
		...
		<h4>CRITERIA FOR REVIEW

		<h4>Abstracts</h4>
		<p>Criteria to be used to evaluate abstracts include the following:</p>
		<ul>
			<li>Relevance of the topic to the conference theme
			<li>Well-defined topics /issue(s) to be examined and discussed 
			<li>Originality and innovativeness of topic 
			<li>Adherence to solid research design and methodology (for research-based papers)
			<li>Limitations identified (for research-based papers)
			<li>Good language and writing quality and logical organization of paper
			<li>Potential contributions to the advancement of communication theory, research and practice
		</ul>
		<h4>Full Papers</h4>
		<p>Criteria to be used to evaluate full papers include the following:</p>
		<ul>
			<li>Extensive and appropriate literature review
			<li>Good writing quality, e.g., style is clear and engaging
			<li>Logical organization of paper
			<li>In-depth and evidence-based analysis and conclusions 
			<li>Concrete recommendations for research, policy, and action projects
			<li>Publication-ready 
		</ul>
