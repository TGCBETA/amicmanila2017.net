...
<body>
	<div class="container">
		<img src="{{ asset('images/header_web.png') }}" class="img-responsive hidden-xs hidden-sm" />
		<img src="{{ asset('images/header_mobile_amicbanner_event.png') }}" class="img-responsive hidden-lg hidden-md" />
		      ...
		      <ul class="nav navbar-nav">
		        ...
		        <li>
		        	...
		        	<ul class="dropdown-menu">
			            <li><a href="{{ route('get-page', ['message-from-the-president']) }}">Message from the President</a></li>
		        ...
		        <li>
		        	...
		        	<ul class="dropdown-menu">
			            ...
			            <li><a href="{{ route('get-page', ['call-for-abstract']) }}">Call for Abstract</a></li>
		...
		<section class="footer2">
			<div class="row">
				...
				<div class="col-md-3">
					...
					<hr />
					<a href="https://www.facebook.com/Amic-Asia-1535143990118695/" target="_blank" class="btn btn-primary btn-block"><i class="fa fa-facebook"></i> Facebook</a>
					<a href="https://twitter.com/AMIC_Asia" target="_blank" class="btn btn-info btn-block"><i class="fa fa-twitter"></i> Twitter</a>
					<a href="https://www.youtube.com/channel/UCA7Vt-q7nCyy5bUBNl83Ltg" target="_blank" class="btn btn-danger btn-block"><i class="fa fa-youtube-square"></i> Youtube</a>
				</div>
				<div class="col-md-3">
